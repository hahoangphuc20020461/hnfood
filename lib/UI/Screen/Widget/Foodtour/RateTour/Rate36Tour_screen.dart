...
class BaSauRatingTourPage extends StatefulWidget {
  const BaSauRatingTourPage({super.key, required this.title});

  final String title;

  @override
  State<BaSauRatingTourPage> createState() => _BaSauRatingTourPageState();
}

class _BaSauRatingTourPageState extends State<BaSauRatingTourPage> {
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: AssetImage('assets/36foodtour.jpg'
                            ),
                            )
                        ),
