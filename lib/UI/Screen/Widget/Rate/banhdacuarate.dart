...
class BanhdacuaRatingPage extends StatefulWidget {
  const BanhdacuaRatingPage({super.key, required this.title});

  final String title;

  @override
  State<BanhdacuaRatingPage> createState() => _BanhdacuaRatingPageState();
}

class _BanhdacuaRatingPageState extends State<BanhdacuaRatingPage> {
                  ...
                  children: [
                    ...
                    onRatingUpdate: (rating) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Cảm ơn bạn đã đánh giá $rating sao cho món ăn này'),
